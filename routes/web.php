...
Route::get('/roles', 'RoleController@view_index');
...
Route::get('/unactivate_role/{id}', 'RoleController@unactivate_role');

Route::get('/activate_role/{id}', 'RoleController@activate_role');

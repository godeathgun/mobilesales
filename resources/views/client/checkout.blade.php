                        ...
                        <form action="#" id="checkout_form" class="checkout_form">
                            ...
                            <div class="checkout_extra">
                                <div>
                                    ...
                                    <label for="checkbox_terms"><img src="frontend/images/check.png" alt=""></label>
                                ...
                                <div>
                                    ...
                                    <label for="checkbox_account"><img src="frontend/images/check.png" alt=""></label>
                                    <span class="checkbox_title">Create an account</span>
                                </div>
                                <div>
                                    <input type="checkbox" id="checkbox_newsletter" name="regular_checkbox"
                                        class="regular_checkbox">
                                    <label for="checkbox_newsletter"><img src="frontend/images/check.png"
                                            alt=""></label>
